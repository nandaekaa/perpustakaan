  ...
  e.extend(n.prototype, {
            ...
            for (M += "<tr>", E = d ? "<td class='ui-datepicker-week-col'>" + this._get(e, "calculateWeek")(H) + "</td>" : "", x = 0; 7 > x; x++)
              (O = g ? g.apply(e.input ? e.input[0] : null, [H]) : [!0, ""]),
                ...
                (E +=
                  ...
                  ((H.getTime() === D.getTime() && Z === e.selectedMonth && e._keyEvent) || (b.getTime() === H.getTime() && b.getTime() === D.getTime()) ? " " + this._dayOverClass : "") +
                  (W ? " " + this._unselectableClass + " ui-state-disabled" : "") +
                  (j && !v ? "" : " " + O[1] + (H.getTime() === G.getTime() ? " " + this._currentClass : "") + (H.getTime() === R.getTime() ? " ui-datepicker-today" : "")) +
                  "'" +
                  ((j && !v) || !O[2] ? "" : " title='" + O[2].replace(/'/g, "&#39;") + "'") +
                  (W ? "" : " data-handler='selectDay' data-event='click' data-month='" + H.getMonth() + "' data-year='" + H.getFullYear() + "'") +
                  ">" +
                  (j && !v
                    ? "&#xa0;"
                    : W
      ...
      _mouseStart: function (t) {
        ...
        return (
          ...
          this._trigger("start", t) === !1
            ? (this._clear(), !1)
            : (this._cacheHelperProportions(), e.ui.ddmanager && !i.dropBehaviour && e.ui.ddmanager.prepareOffsets(this, t), this._normalizeRightBottom(), this._mouseDrag(t, !0), e.ui.ddmanager && e.ui.ddmanager.dragStart(this, t), !0)
        );
      },
    ...
    e.widget("ui.resizable", e.ui.mouse, {
      ...
      _getPaddingPlusBorderDimensions: function (e) {
        for (
          var t = 0, i = [], s = [e.css("borderTopWidth"), e.css("borderRightWidth"), e.css("borderBottomWidth"), e.css("borderLeftWidth")], n = [e.css("paddingTop"), e.css("paddingRight"), e.css("paddingBottom"), e.css("paddingLeft")];
          4 > t;
          t++
        )
        ...
        (s.grid = h),
          ...
          /^(se|s|e)$/.test(r)
            ...
            : ((0 >= f - u || 0 >= p - l) && (t = i._getPaddingPlusBorderDimensions(this)),
              ...
              p - l > 0 ? ((i.size.width = p), (i.position.left = o.left - d)) : ((p = u - t.height), (i.size.width = p), (i.position.left = o.left + a.width - p)));
      },
    }),
    e.ui.resizable,
    e.widget("ui.dialog", {
  ...
  (e.effects = { effect: {} }),
                ...
                l
                  ...
                  : (i.selecting &&
                      ((t.metaKey || t.ctrlKey) && i.startselected
                        ...
                        : (i.$element.removeClass("ui-selecting"), (i.selecting = !1), i.startselected && (i.$element.addClass("ui-unselecting"), (i.unselecting = !0)), s._trigger("unselecting", t, { unselecting: i.element }))),
                    i.selected &&
                      (t.metaKey ||
                        t.ctrlKey ||
                        i.startselected ||
    ...
    e.widget("ui.slider", e.ui.mouse, {
      ...
      _mouseStop: function (e) {
        return (
          this.handles.removeClass("ui-state-active"), (this._mouseSliding = !1), this._stop(e, this._handleIndex), this._change(e, this._handleIndex), (this._handleIndex = null), (this._clickOffset = null), (this._animateOff = !1), !1
        );
      },
          ...
          for (i = c.length - 1; i >= 0; i--)
            for (n = e(c[i]), s = n.length - 1; s >= 0; s--)
              (a = e.data(n[s], this.widgetFullName)),
                a && a !== this && !a.options.disabled && (d.push([e.isFunction(a.options.items) ? a.options.items.call(a.element[0], t, { item: this.currentItem }) : e(a.options.items, a.element), a]), this.containers.push(a));
        ...
        (this.tablist = this._getList()
          ...
          this.anchors.each(function (i, s) {
            ...
            t._isLocal(s)
              ...
              : ((o = h.attr("aria-controls") || e({}).uniqueId()[0].id), (n = "#" + o), (a = t.element.find(n)), a.length || ((a = t._createPanel(o)), a.insertAfter(t.panels[i - 1] || t.tablist)), a.attr("aria-live", "polite")),
